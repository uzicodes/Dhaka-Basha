    ...
    <div className="flex flex-col gap-1.5 mt-2">
      ...
      {totalImageCount < 5 && (
        <div
          ...
          className="border-2 border-dashed border-[#EBE3A7] rounded-none h-32 flex flex-col items-center justify-center bg-slate-50 text-slate-400 hover:border-[#EB7D00] hover:bg-[#EBE3A7]/40 transition-colors cursor-pointer"
        >
