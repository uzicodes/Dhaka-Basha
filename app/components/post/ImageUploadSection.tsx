    ...
    <div className="flex flex-col gap-1.5 mt-2">
      ...
      {totalImageCount < 5 && (
        <div
          ...
          className="border-2 border-dashed border-[#2C5745]/25 rounded-xl h-32 flex flex-col items-center justify-center bg-[#EBE3A7]/20 text-[#2C5745] hover:border-[#EB7D00] hover:bg-[#EBE3A7]/50 transition-colors cursor-pointer"
        >
