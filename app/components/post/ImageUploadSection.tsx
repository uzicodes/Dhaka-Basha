    ...
    <div className="flex flex-col gap-1.5 mt-2">
      ...
      {totalImageCount < 5 && (
        <button
          ...
          className="w-full border-2 border-dashed border-[#2C5745]/25 rounded-xl h-32 flex flex-col items-center justify-center bg-[#EBE3A7]/20 text-[#2C5745] hover:border-[#EB7D00] hover:bg-[#EBE3A7]/50 transition-colors cursor-pointer"
        >
          <svg className="w-8 h-8 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
          <span className="text-sm font-medium">ছবি যোগ করতে এখানে ক্লিক করুন</span>
          <span className="text-xs mt-1 text-slate-500 font-semibold">{totalImageCount}/৫ টি ছবি</span>
        </button>
      )}
