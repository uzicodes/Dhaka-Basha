    ...
    <main className="min-h-screen bg-[#fafcf9] flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl px-4 sm:px-6 lg:px-8 pt-28 md:pt-32 pb-20 space-y-12">
        ...
        <section className="text-center space-y-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#E1E100]/25 border border-[#90B800]/40 text-[#063B00] text-xs font-bold shadow-2xs">
            <span className="w-2 h-2 rounded-full bg-[#266210] animate-pulse" />
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#063B00] tracking-tight leading-tight">
            আমরা আছি <span className="text-[#266210]">আপনার পাশে</span>
          </h1>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all flex flex-col items-center text-center space-y-3">
            <div className="w-12 h-12 rounded-2xl bg-[#90B800]/20 text-[#063B00] flex items-center justify-center">
          ...
          {/* Card 2: Phone */}
          <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all flex flex-col items-center text-center space-y-3">
            <div className="w-12 h-12 rounded-2xl bg-[#266210]/15 text-[#266210] flex items-center justify-center">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="text-xs font-bold text-[#063B00] bg-[#90B800]/20 hover:bg-[#90B800]/30 px-3.5 py-1 rounded-full transition-colors"
            >
              +৮৮০ ১৭০০-০০০০০০
            </a>
          </div>
          ...
          {/* Card 3: Email */}
          <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all flex flex-col items-center text-center space-y-3">
            <div className="w-12 h-12 rounded-2xl bg-[#063B00]/10 text-[#063B00] flex items-center justify-center">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-5">
              <div className="inline-flex items-center gap-2">
                <span className="w-6 h-0.5 bg-[#266210] rounded-full" />
                <span className="text-xs font-bold uppercase tracking-wider text-[#266210]">আমাদের লক্ষ্য ও উদ্দেশ্য</span>
              </div>

              <h2 className="text-2xl sm:text-3xl font-extrabold text-[#063B00] leading-snug">
                ঢাকা শহরে বাসা খোঁজার অভিজ্ঞতাকে <span className="text-[#266210]">সহজ ও বিশ্বস্ত</span> করা
              </h2>

              <p className="text-sm text-slate-600 leading-relaxed">
                <strong className="text-[#063B00]">ঢাকা-বাসা</strong> হলো রাজধানী ঢাকায় বাসা, মেস, ফ্ল্যাট এবং অফিস স্পেস খোঁজার আধুনিক ডিজিটাল সমাধান। কোনো মধ্যস্বত্বভোগী বা ব্রোকার ছাড়া সরাসরি বাড়ির মালিক ও ভাড়াটিয়ার মাঝে সংযোগ ঘটিয়ে দিতে আমাদের এই প্ল্যাটফর্ম তৈরি।
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                {[
                  ...
                  <div key={idx} className="flex items-start gap-2.5 p-3 rounded-2xl bg-[#fafcf9] border border-slate-100">
                    <span className="w-5 h-5 rounded-full bg-[#266210] text-white text-xs flex items-center justify-center shrink-0 font-bold mt-0.5">✓</span>
            ...
            <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-4">
              <h3 className="text-lg font-bold text-[#063B00]">সাধারণ কিছু প্রশ্নোত্তর (FAQ)</h3>
              
              <div className="space-y-3">
                <div className="p-4 rounded-2xl bg-[#fafcf9] border border-slate-100 space-y-1">
                  <h4 className="text-xs font-bold text-[#063B00]">বিজ্ঞাপন দিতে কি কোনো ফি লাগে?</h4>
