    ...
    <main className="min-h-screen bg-[#EBE3A7] flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl px-4 sm:px-6 lg:px-8 pt-28 md:pt-32 pb-20 space-y-12">
        ...
        <section className="text-center space-y-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#EBE3A7]/25 border border-[#EBE3A7]/40 text-[#2E2910] text-xs font-bold shadow-2xs">
            <span className="w-2 h-2 rounded-full bg-[#2C5745] animate-pulse" />
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all flex flex-col items-center text-center space-y-3">
            <div className="w-12 h-12 rounded-2xl bg-[#EBE3A7]/20 text-[#2E2910] flex items-center justify-center">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
            </div>
            <h3 className="font-sans text-base font-bold text-[#2E2910]">হেড অফিস</h3>
            <p className="text-xs text-slate-500">ঢাকা শহর, বাংলাদেশ</p>
            <span className="text-[11px] font-semibold text-[#2E2910] bg-[#EBE3A7]/20 px-2.5 py-1 rounded-full">
          ...
          {/* Card 2: Phone */}
          <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all flex flex-col items-center text-center space-y-3">
            <div className="w-12 h-12 rounded-2xl bg-[#2C5745]/15 text-[#2C5745] flex items-center justify-center">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
            </div>
            <h3 className="font-sans text-base font-bold text-[#2E2910]">ফোন সাপোর্ট</h3>
            <p className="text-xs text-slate-500">সকাল ৯টা থেকে রাত ১০টা পর্যন্ত</p>
            <a
              href="tel:+8801700000000"
              className="text-xs font-bold text-[#2E2910] bg-[#EBE3A7]/20 hover:bg-[#EBE3A7]/30 px-3.5 py-1 rounded-full transition-colors"
            >
              +৮৮০ ১৭০০-০০০০০০
            </a>
          </div>
          ...
          {/* Card 3: Email */}
          <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all flex flex-col items-center text-center space-y-3">
            <div className="w-12 h-12 rounded-2xl bg-[#2E2910]/10 text-[#2E2910] flex items-center justify-center">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="font-sans text-base font-bold text-[#2E2910]">ইমেইল সাপোর্ট</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-5">
              <div className="inline-flex items-center gap-2">
                ...
                <span className="text-xs font-bold uppercase tracking-wider text-[#2C5745]">আমাদের লক্ষ্য ও উদ্দেশ্য</span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                {[
                  ...
                  <div key={idx} className="flex items-start gap-2.5 p-3 rounded-2xl bg-[#EBE3A7] border border-slate-100">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-4">
              <h3 className="text-lg font-bold text-[#2E2910]">সাধারণ কিছু প্রশ্নোত্তর (FAQ)</h3>
              
              <div className="space-y-3">
                <div className="p-4 rounded-2xl bg-[#EBE3A7] border border-slate-100 space-y-1">
                  <h4 className="text-xs font-bold text-[#2E2910]">বিজ্ঞাপন দিতে কি কোনো ফি লাগে?</h4>
                ...
                <div className="p-4 rounded-2xl bg-[#EBE3A7] border border-slate-100 space-y-1">
                  <h4 className="text-xs font-bold text-[#2E2910]">মালিকের সাথে কীভাবে কথা বলব?</h4>
