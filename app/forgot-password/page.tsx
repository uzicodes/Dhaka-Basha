...
function ResetRequestForm({
  handlePasswordResetRequest, error, email, setEmail, isProcessing
}: any) {
  return (
    <form
...
function ResetPasswordForm({
  handlePasswordReset, error, email, code, setCode, password, setPassword,
  showPassword, setShowPassword, isProcessing, setSuccessfulCreation, setError
}: any) {
  return (
    <form
