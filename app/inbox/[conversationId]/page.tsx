...
export default async function ConversationPage({
    ...
    return (
      <main className="min-h-screen bg-[#EBE3A7] flex flex-col items-center justify-center px-4 pt-28 pb-12">
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-200 text-center max-w-md w-full space-y-4">
          ...
          <h2 className="text-lg font-bold text-[#2E2910]">কথোপকথন পাওয়া যায়নি</h2>
  ...
  return (
    <main className="grow flex flex-col bg-[#EBE3A7] pt-20 md:pt-28 px-2 sm:px-4 min-h-screen h-screen">
      {/* Background Decorative Accent */}
      <div className="absolute inset-x-0 top-0 h-64 bg-gradient-to-b from-[#EBE3A7]/15 via-[#2C5745]/5 to-transparent pointer-events-none -z-10" />
