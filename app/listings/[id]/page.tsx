      ...
      <div className="w-full max-w-6xl px-4 sm:px-6 lg:px-8 pt-28 md:pt-32 pb-20 space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-600 font-medium">
            <Link
              href={backHref}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white text-[#2E2910] hover:text-[#2C5745] border border-slate-200 shadow-2xs transition-colors font-bold text-sm"
            >
            ...
            <span className="hidden sm:inline text-slate-700 font-bold truncate max-w-xs">{locLabel}</span>
          </div>
            ...
            {!isOwner && (
              currentUser ? (
                <form action={handleToggleSaveAction}>
                  <button
                    type="submit"
                    className={`inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold border transition-all cursor-pointer shadow-2xs ${
                      isSaved
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold border bg-white border-slate-200 text-slate-700 hover:text-rose-600 hover:border-rose-200 shadow-2xs transition-all"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-5 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-6">
              ...
              <div className="space-y-3.5">
                <div className="flex flex-wrap items-center gap-2.5">
                  ...
                  <span className="px-3.5 py-1.5 rounded-full bg-slate-100 text-slate-700 text-sm font-medium flex items-center gap-1.5">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#2E2910] leading-snug">
                  {listing.title}
                </h1>
              </div>
            ...
            <div className="bg-white p-5 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-4">
              <h3 className="text-lg sm:text-xl font-bold text-[#2E2910] flex items-center gap-2.5">
              ...
              <div className="bg-[#EBE3A7] p-4 sm:p-5 rounded-2xl border border-slate-100 space-y-2">
                <div className="text-base sm:text-lg font-bold text-slate-900 flex items-center gap-2">
                  <span>{locLabel}</span>
                  {subLocLabel && (
                    <span className="px-2.5 py-0.5 rounded-md bg-[#EBE3A7]/30 text-[#2E2910] text-xs sm:text-sm font-bold border border-[#EBE3A7]/50">
                      {subLocLabel}
                    </span>
                  )}
                </div>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-bold text-[#2C5745] hover:text-[#2E2910] transition-colors pt-1"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white p-5 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-4">
              <h3 className="text-lg sm:text-xl font-bold text-[#2E2910] flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-full bg-[#EBE3A7]/20 text-[#2E2910] flex items-center justify-center">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-slate-800 text-base sm:text-lg leading-relaxed whitespace-pre-line font-normal bg-[#EBE3A7] p-5 sm:p-6 rounded-2xl border border-slate-100">
                {listing.description || "এই বিজ্ঞাপনের জন্য কোনো বিস্তারিত বিবরণ দেওয়া হয়নি।"}
              </div>
            </div>

            {/* SAFETY & GUIDELINES CALLOUT */}
            <div className="bg-amber-50/70 border border-amber-200/80 rounded-3xl p-5 sm:p-6 space-y-2">
              ...
              <p className="text-sm text-amber-900 leading-relaxed font-normal">
                বাসা সরাসরি পরিদর্শন না করে এবং মালিকের পরিচয় নিশ্চিত না করে কখনোই কোনো অগ্রিম টাকা বা বুকিং মানি পাঠাবেন না। যেকোনো ধরনের আর্থিক লেনদেনের জন্য &quot;ঢাকা-বাসা&quot; কর্তৃপক্ষ কোনোভাবেই দায়ী থাকবে না।
              </p>
            </div>
          ...
          <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-28">
            ...
            <div className="bg-white rounded-3xl border border-slate-200/90 shadow-md shadow-slate-200/50 overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                ...
                {/* Price Display */}
                <div>
                  <span className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">মাসিক ভাড়া</span>
                  <div className="flex items-baseline gap-1.5">
                    ...
                    <span className="text-base font-semibold text-slate-500"> / মাস</span>
                  </div>
                </div>

                {/* Contact Box */}
                {listing.contactInfo && (
                  <div className="bg-[#EBE3A7] p-4 sm:p-5 rounded-2xl border border-slate-100 text-center space-y-1.5">
                    <span className="text-xs font-bold text-slate-500 uppercase tracking-wider block">যোগাযোগের নম্বর</span>
                    <div className="flex items-center justify-center gap-2">
                      <svg className="w-5 h-5 text-[#2C5745]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      <span className="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-wide">{listing.contactInfo}</span>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-3">
                    {listing.contactInfo && (
                      <a
                        ...
                        className="w-full h-12 bg-[#2C5745] hover:bg-[#2E2910] active:scale-[0.98] text-white font-bold text-base rounded-xl shadow-md shadow-[#2C5745]/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>
              ...
              <div className="flex items-start gap-3.5">
                <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-2xl bg-[#EBE3A7]/20 text-[#2E2910] overflow-hidden border border-slate-200 shrink-0 flex items-center justify-center font-bold text-lg mt-0.5">
                  {listing.user.profileImage ? (
                    ...
                    <Image src={authorClerkImage} alt={listing.user.name || ""} width={56} height={56} className="object-cover" />
                  ) : (
            ...
            {similarListings.length > 0 && (
              <div className="bg-white p-5 sm:p-6 rounded-3xl border border-slate-200/80 shadow-xs space-y-3.5">
                ...
                <div className="space-y-3">
                  {similarListings.map((sim: any) => (
                    <Link
                      ...
                      className="group flex items-center justify-between p-3 rounded-2xl hover:bg-[#EBE3A7] border border-transparent hover:border-slate-100 transition-colors"
                    >
                      <div className="min-w-0 pr-2 space-y-0.5">
                        <p className="text-sm font-bold text-slate-900 group-hover:text-[#2C5745] transition-colors truncate">
                          {sim.title}
                        </p>
                      ...
                      <span className="text-sm sm:text-base font-extrabold text-red-600 shrink-0">
