...
export default function SignUp() {
  ...
  // FIXED 1: Added 'as any' back to bypass the Clerk v5 Signal typing quirk
  ...
  const onPressVerify = async (e: React.FormEvent) => {
    ...
    try {
      // FIXED 3: Updated to Clerk v5 attemptVerification method
  ...
  return (
    <main className="grow flex flex-col items-center justify-center px-4 bg-slate-50 pt-32 pb-12">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-1 bg-white p-4 w-full max-w-112.5 rounded-[20px] shadow-sm border-2 border-[#2d79f3]">
        ...
        <button type="button" onClick={signUpWithGoogle} className="mt-1 w-30 h-11 mx-auto rounded-[10px] flex justify-center items-center font-medium text-[14px] text-black gap-2 border border-[#2d79f3] bg-white cursor-pointer transition-all duration-200 hover:bg-green-200 hover:shadow-lg hover:scale-105">
